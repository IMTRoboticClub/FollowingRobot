...
CoordonneeGPS test2CoorPlateforme = CoordonneeGPS(43.90*Utils::degToRad, Utils::nbModulo2PI(-19*Utils::degToRad));
CoordonneeGPS test2CoorUser = CoordonneeGPS(49.3*Utils::degToRad, Utils::nbModulo2PI(-12*Utils::degToRad));
