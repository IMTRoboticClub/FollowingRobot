...
int Plateforme::vitesseEnTournant = 75;
...
void Plateforme::avance(int vitesse) 
{
    m_moteurGauche.tourneVersGauche(vitesse);
    m_moteurDroit.tourneVersDroite(vitesse);
}

void Plateforme::recule(int vitesse)
{
    m_moteurGauche.tourneVersDroite(vitesse);
    m_moteurDroit.tourneVersGauche(vitesse);
}

void Plateforme::tournerAGauche()
{
    m_moteurGauche.stop();
    m_moteurDroit.tourneVersGauche(vitesseEnTournant);
}

void Plateforme::tournerADroite()
{
    m_moteurGauche.tourneVersDroite(vitesseEnTournant);
    m_moteurDroit.stop();
}
